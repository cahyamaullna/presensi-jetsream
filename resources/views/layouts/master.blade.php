        ...
        <ul class="navbar-nav navbar-right">
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
            ...
            <div class="dropdown-menu dropdown-menu-right">
              ...
              <a href="http://absensi-jetstream.test/user/profile" class="dropdown-item has-icon">
      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="index.html">Presensi Wikrama</a>
          </div>
          <ul class="sidebar-menu">
              ...
              <li class="nav-item dropdown active">
                ...
                <ul class="dropdown-menu">
                  <li><a class="nav-link" href="students">Daftar Siswa</a></li>
                  <li><a class="nav-link" href="rombel">Daftar Rombel</a></li>
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a class="nav-link" href="/calendar">Kalender</a></li>
                </ul>
              </li>
              
              @if (auth()->user()->level == "admin")
              <div class="mt-4 mb-4 p-3 hide-sidebar-mini">
              <a href="admin" class="btn btn-primary btn-lg btn-block btn-icon-split">
